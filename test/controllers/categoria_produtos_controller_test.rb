...
class CategoriaProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create categoria_produto" do
    assert_difference("CategoriaProduto.count") do
      post categoria_produtos_url, params: { categoria_produto: { categoria_id: @categoria_produto.categoria_id, produto_id: @categoria_produto.produto_id } }
    end
  ...
  test "should update categoria_produto" do
    patch categoria_produto_url(@categoria_produto), params: { categoria_produto: { categoria_id: @categoria_produto.categoria_id, produto_id: @categoria_produto.produto_id } }
